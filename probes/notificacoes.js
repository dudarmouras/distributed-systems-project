...
const PROBE_ID = "probe_notificacoes";
const METRICS_TOPIC = `probes/${PROBE_ID}/metrics`;
const CONTROL_TOPIC = `probes/control`;
const BROKER_URL = process.env.MQTT_BROKER_URL || "mqtt://localhost:1883";

// Faixa de latência base do serviço (ms). Notificações enviam emails/SMS
// através de provedores externos, então é um serviço lento (50ms a 200ms).
const LAT_MIN = 50;
const LAT_MAX = 200;
